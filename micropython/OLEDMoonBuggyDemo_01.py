"""
================================================================================
HAL 9000: BARE-METAL SSD1306 DRIVER (128x32) & VECTOR MOON PATROL v9.4
...
# ==============================================================================
# MAIN DEMO: VECTOR MOON PATROL v9.4 (SAFE SPAWN & VARIABLE CHASMS)
# ==============================================================================

def get_terrain_y(wx):
    """Procedural terrain with Safe Zones and Variable Chasms."""
    ...
    # 3. Stalagmites / Spikes
    s = math.sin(wx * 0.06)
    if s > 0.85:
        y -= (s - 0.85) * 40 
        
    # 4. Chasms (Variable Width & Safe Zone)
    # Give the player 250 pixels of safe runway to land and gain speed
    if wx > 250:
        # Modulate the threshold to create variable gap widths
        threshold = 0.94 + math.sin(wx * 0.011) * 0.035
        c = math.sin(wx * 0.025)
        if c > threshold: 
            y += 40 # Drop down off screen
...
def run_moon_rover_demo():
    print("HAL 9000: Initializing Safe Spawn Routine...")
    ...
    try:
        while True:
            ...
            if rover_y > 40: # Death: Reset and give runway
                world_x = 0.0
                rover_y = -5.0 
                vy = 0.0
                current_speed = 1.0
